  ...
  return (
    <div className="container">
      <div
        ...
        <h2 className="card text-white bg-primary mb-1 pb-2">Arpan School Application</h2>
        ...
        <h6 className="card text-dark bg-warning py-1">All rights reserved Arpan Products &copy; 2024</h6>
      </div>
    </div>
  );
}
